defmodule Ocular.Accounts.PlayerToken do
  use Ecto.Schema
  import Ecto.Query
  alias Ocular.Accounts.PlayerToken
  ...
  schema "players_tokens" do
    ...
    belongs_to :player, Ocular.Accounts.Player
  ...
  Therefore, storing them allows individual player
  ...
  @doc """
  Builds a token and its hash to be delivered to the player's email.
  ...
  This is used to validate requests to change the player
