defmodule OcularWeb.PlayerAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OcularWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_player/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OcularWeb.Endpoint.subscribe(live_socket_id)
