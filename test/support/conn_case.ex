defmodule OcularWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use OcularWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import OcularWeb.ConnCase
    end
  end

  setup tags do
    Ocular.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = Ocular.AccountsFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = Ocular.Accounts.generate_player_session_token(player)
